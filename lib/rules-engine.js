...
const REMOTE_RULES_URL = 'https://raw.githubusercontent.com/haKC-ai/promptforge/main/rules.json';
...
const COMPRESSION_PRESETS = {
  ...
  light: {
    ...
    icon: '[2]',
    enabledCategories: ['formatting', 'fluff']
  },
  medium: {
    name: 'Medium',
    description: 'Recommended - removes fluff and redundancy',
    icon: '[3]',
    enabledCategories: ['formatting', 'fluff', 'redundancy']
  },
  heavy: {
    name: 'Heavy',
    description: 'Aggressive - strips most non-essential content',
    icon: '[4]',
    enabledCategories: ['formatting', 'fluff', 'redundancy', 'verbosity', 'qualifiers', 'structure']
  },
  maximum: {
    name: 'Maximum',
    description: 'Extreme - deep compression (may alter meaning)',
    icon: '[5]',
    enabledCategories: ['formatting', 'fluff', 'redundancy', 'verbosity', 'qualifiers', 'structure', 'compression']
  },
  custom: {
    name: 'Custom',
